...
class ua{constructor(){this.i=new sa(this);this.g=new Set;this.element=document.createElement("div");this.o=document.querySelector("#scene-parent");this.o.appendChild(this.element);this.element.id="scene";this.o.id="scene-parent"}add(a){this.g.add(a);this.element.appendChild(a.element)}remove(a){this.g.delete(a);this.element.removeChild(a.element)}}
